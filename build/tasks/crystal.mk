...
CRYSTAL_TARGET_PACKAGE := $(PRODUCT_OUT)/ENG-CrystalOS-$(CRYSTAL_VERSION)-$(CRYSTAL_VERSION_NAME)-$(CRYSTAL_BUILD_TYPE)-$(CRYSTAL_DEVICE)-$(CRYSTAL_BUILD_DATE)-$(shell date -u +%H%M%S).zip
else
CRYSTAL_TARGET_PACKAGE := $(PRODUCT_OUT)/CrystalOS-$(CRYSTAL_VERSION)-$(CRYSTAL_VERSION_NAME)-$(CRYSTAL_BUILD_TYPE)-$(CRYSTAL_DEVICE)-$(CRYSTAL_BUILD_DATE)-$(shell date -u +%H%M%S).zip
endif
