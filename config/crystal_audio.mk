...
ALARM_PATH := vendor/crystal/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/crystal/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/crystal/prebuilt/common/media/audio/ringtones
...
PRODUCT_COPY_FILES += \
    ...
    $(NOTIFICATION_PATH)/Argon.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/notifications/Argon.ogg
