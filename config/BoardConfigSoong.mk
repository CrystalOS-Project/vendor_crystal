...
# Documentation here:
# https://github.com/CrystalOS/android_build_soong/commit/8328367c44085b948c003116c0ed74a047237a69
...
define addVar
  ...
  SOONG_CONFIG_crystalVarsPlugin_$(1) := $$(subst ",\",$$($1))
endef
...
SOONG_CONFIG_crystalQcomVars_legacy_hw_disk_encryption := $(TARGET_LEGACY_HW_DISK_ENCRYPTION)
...
SOONG_CONFIG_crystalGlobalVars_target_surfaceflinger_fod_lib := $(TARGET_SURFACEFLINGER_FOD_LIB)
