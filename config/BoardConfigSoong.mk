...
SOONG_CONFIG_crystalGlobalVars_include_miui_camera := $(TARGET_INCLUDES_MIUI_CAMERA)
...
SOONG_CONFIG_crystalQcomVars_qti_vibrator_effect_lib := $(TARGET_QTI_VIBRATOR_EFFECT_LIB)
